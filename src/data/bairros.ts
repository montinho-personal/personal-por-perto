...
export const bairros: Bairro[] = [
  ...
  { slug: 'personal-trainer-flamengo', nome: 'Flamengo', locucao: 'no Flamengo', cidade: 'rio-de-janeiro-rj', zona: 'Zona Sul', prioridade: 2,
    descricao: 'Prédios antigos sem academia própria, de frente para o maior parque urbano à beira-mar do mundo — o treino aqui acontece fora de casa.',
  },
  ...
  { slug: 'personal-trainer-recreio-dos-bandeirantes', nome: 'Recreio dos Bandeirantes', locucao: 'no Recreio dos Bandeirantes', cidade: 'rio-de-janeiro-rj', zona: 'Zona Oeste', prioridade: 2,
    descricao: 'Cinco quilômetros de praia contínua, condomínios de prédio baixo com academia própria e o começo da ciclovia que segue pela orla carioca.',
    relacionados: [{ slug: 'personal-trainer-barra-da-tijuca', motivo: 'o bairro vizinho da mesma região administrativa — mesma lógica de condomínio, distâncias ainda maiores' }],
  },
