...
/**
 * Mapa slug -> estado, para lookups O(1). O resolver da hierarquia geográfica
 * (`src/lib/geo.ts`) precisa resolver estado a partir da cidade em toda página
 * de bairro; varrer o array a cada chamada seria desperdício e, pior, abriria
 * espaço para cada chamador reimplementar a busca do seu jeito.
 */
export const estadoPorSlug: Record<string, Estado> = Object.fromEntries(
