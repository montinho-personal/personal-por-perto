...
export const cidade: Cidade = {
  ...
  capaArte: {
    ...
    h: 675,
    alt:
      'Personal trainer em Juiz de Fora (MG) em arte que une treino de força e o cartão-postal real da cidade — o Morro do Cristo com a estátua no topo e o casario e prédios do centro entre as montanhas da Zona da Mata — Personal por Perto',
    legenda:
      'Treino personalizado em Juiz de Fora: um plano feito para o seu corpo e a sua rotina, com acompanhamento profissional na cidade e região.',
  },
};
