...
export const cidade: Cidade = {
  ...
  capaArte: {
    src: '/capas-cidade/rio-branco-ac.webp',
    w: 1200,
    h: 849,
    alt:
      'Personal trainer em Rio Branco (AC) em arte que reúne corrida e kettlebell, a Passarela Joaquim Macedo, a Gameleira, o Palácio Rio Branco e o Parque da Maternidade — Personal por Perto',
    legenda:
      'Treino personalizado em Rio Branco: um plano feito para o seu corpo e a sua rotina, com acompanhamento profissional na cidade e região.',
  },
};
